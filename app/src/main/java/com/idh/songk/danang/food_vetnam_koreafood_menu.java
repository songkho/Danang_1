    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //--------------- END --------------- 하단광고
            ...
            public void onClick(View v) {
                Intent intent = new Intent(food_vetnam_koreafood_menu.this, food_vetnam_koreafood_menu_kogurea.class);
        ...
        li2.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(food_vetnam_koreafood_menu.this, food_vetnam_koreafood_menu_hoho.class);
                startActivity(intent);
        ...
        li3.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(food_vetnam_koreafood_menu.this, food_vetnam_koreafood_menu_muksam.class);
                startActivity(intent);
        ...
        li4.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(food_vetnam_koreafood_menu.this, food_vetnam_koreafood_menu_oppa.class);
                startActivity(intent);
        ...
        li5.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(food_vetnam_koreafood_menu.this, food_vetnam_koreafood_menu_bebe.class);
                startActivity(intent);
