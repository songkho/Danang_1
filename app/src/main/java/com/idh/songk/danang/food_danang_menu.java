...
public class food_danang_menu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_menu_danang);
...
//
            ...
            public void onClick(View v) {
                Intent intent = new Intent(food_danang_menu.this, food_danang_menu_ricenoddle.class);
        ...
        li2.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(food_danang_menu.this, food_danang_menu_bonpas.class);
                startActivity(intent);
        ...
        li3.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(food_danang_menu.this, food_danang_menu_coconut.class);
                startActivity(intent);
        ...
        li4.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(food_danang_menu.this, food_danang_menu_banceo.class);
                startActivity(intent);
        ...
        li5.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(food_danang_menu.this, food_danang_menu_buncha.class);
                startActivity(intent);
        ...
        li6.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(food_danang_menu.this, food_danang_menu_mrbanmi.class);
                startActivity(intent);
...
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(food_danang_menu.this, resort_hoianpesta.class);
//                startActivity(intent);
//
//                if (mInterstitialAd.isLoaded()) {
//                    mInterstitialAd.show();
...
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(food_danang_menu.this, resort_goldenbay.class);
//                startActivity(intent);
//
//                if (mInterstitialAd.isLoaded()) {
//                    mInterstitialAd.show();
