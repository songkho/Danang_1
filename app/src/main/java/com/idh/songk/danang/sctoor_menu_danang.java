...
public class sctoor_menu_danang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sctoor_menu_danang);
        ...
        //--------------- END --------------- 하단광고
            ...
            public void onClick(View v) {
                Intent intent = new Intent(sctoor_menu_danang.this, hoianfood.class);
...
//                }
        ...
        li2.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(sctoor_menu_danang.this, food_hoian_menu_nihan.class);
                startActivity(intent);
        ...
        li3.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(sctoor_menu_danang.this, food_hoian_menu_tuan.class);
                startActivity(intent);
        ...
        li4.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(sctoor_menu_danang.this, food_hoian_menu_woodfire.class);
                startActivity(intent);
        ...
        li5.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(sctoor_menu_danang.this, food_hoian_menu_garden.class);
                startActivity(intent);
