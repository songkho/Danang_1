...
public class playnight_apobeachclub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_playnight_apobeachclub);
        ...
        li5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setData(Uri.parse("https://www.google.com/maps/search/?api=1&query=Apocalypse%20Beach%20Club&query_place_id=ChIJk5LiwCUXQjERh2k6NF9DCl4"));
        ...
        li6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Intent.ACTION_VIEW);
                intent.setData(Uri.parse("https://www.instagram.com/explore/tags/apocalypsebeachclub/?hl=ko"));
