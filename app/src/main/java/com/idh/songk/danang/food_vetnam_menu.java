...
public class food_vetnam_menu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_menu_vetnam);
        ...
        //--------------- END --------------- 하단광고
            ...
            public void onClick(View v) {
                Intent intent = new Intent(food_vetnam_menu.this, food_vetnam_menu_ricenoddle.class);
        ...
        li2.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(food_vetnam_menu.this, food_vetnam_menu_banmi.class);
                startActivity(intent);
        ...
        li3.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(food_vetnam_menu.this, food_vetnam_menu_bucha.class);
                startActivity(intent);
        ...
        li4.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(food_vetnam_menu.this, food_vetnam_menu_coffee.class);
                startActivity(intent);
        ...
        li5.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(food_vetnam_menu.this, food_vetnam_menu_banxeo.class);
                startActivity(intent);
        ...
        li6.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(food_vetnam_menu.this, food_vetnam_menu_walnam.class);
                startActivity(intent);
        ...
        li7.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(food_vetnam_menu.this, food_vetnam_menu_jajo.class);
                startActivity(intent);
        ...
        li8.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(food_vetnam_menu.this, food_vetnam_menu_comga.class);
                startActivity(intent);
