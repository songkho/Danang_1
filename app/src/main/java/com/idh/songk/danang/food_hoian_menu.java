...
public class food_hoian_menu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_menu_hoian);
        ...
        //--------------- END --------------- 하단광고
            ...
            public void onClick(View v) {
                Intent intent = new Intent(food_hoian_menu.this, hoianfood.class);
...
//                }
        ...
        li2.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(food_hoian_menu.this, food_hoian_menu_nihan.class);
                startActivity(intent);
        ...
        li3.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(food_hoian_menu.this, food_hoian_menu_tuan.class);
                startActivity(intent);
        ...
        li4.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(food_hoian_menu.this, food_hoian_menu_woodfire.class);
                startActivity(intent);
        ...
        li5.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(food_hoian_menu.this, food_hoian_menu_garden.class);
                startActivity(intent);
