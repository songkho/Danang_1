...
public class tatoo_menu_danang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tatoo_menu_danang);
        ...
        //--------------- END --------------- 하단광고
            ...
            public void onClick(View v) {
                Intent intent = new Intent(tatoo_menu_danang.this, tatoo_menu_danang_lament.class);
        ...
        li2.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(tatoo_menu_danang.this, tatoo_menu_danang_tuantatoo.class);
                startActivity(intent);
        ...
        li3.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(tatoo_menu_danang.this, tatoo_menu_danang_bomtatoo.class);
                startActivity(intent);
        ...
        li4.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(tatoo_menu_danang.this, tatoo_menu_danang_monkeytatoo.class);
                startActivity(intent);
        ...
        li5.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(tatoo_menu_danang.this, tatoo_menu_danang_liketatoo.class);
                startActivity(intent);
...
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(food_hoian_menu.this, resort_fusion.class);
//                startActivity(intent);
//
//                if (mInterstitialAd.isLoaded()) {
//                    mInterstitialAd.show();
...
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(food_hoian_menu.this, resort_hoianpesta.class);
//                startActivity(intent);
//
//                if (mInterstitialAd.isLoaded()) {
//                    mInterstitialAd.show();
