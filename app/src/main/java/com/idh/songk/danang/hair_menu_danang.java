...
public class hair_menu_danang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hair_menu_danang);
...
//                Intent intent = new Intent(hair_menu_danang.this, hoianfood.class);
...
//        });
        ...
        li2.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(hair_menu_danang.this, hair_menu_danang_king.class);
                startActivity(intent);
        ...
        li3.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(hair_menu_danang.this, hair_menu_danang_gohang.class);
                startActivity(intent);
        ...
        li4.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(hair_menu_danang.this, hair_menu_danang_seoul.class);
                startActivity(intent);
        ...
        li5.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(hair_menu_danang.this, hair_menu_danang_gangnam.class);
                startActivity(intent);
        ...
        li6.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(hair_menu_danang.this, hair_menu_danang_danangjeil.class);
                startActivity(intent);
